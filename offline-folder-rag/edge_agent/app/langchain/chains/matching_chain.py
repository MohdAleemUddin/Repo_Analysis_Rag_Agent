...
def run_matching(
    ...
    if content_types_for_template is not None and is_single_type is not None:
        if is_single_type:
            ...
            result["intelligence_reason"] = "Single content type; using single-type format."
            ...
            result["intelligence_reason"] = "Multiple content types; using mixed format."
    ...
    if not result["template_id"] and vector_store is not None and hasattr(vector_store, "similarity_search"):
        try:
