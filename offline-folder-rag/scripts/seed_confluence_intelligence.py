...
def main() -> int:
    ...
    for i in range(52):
        ...
        tid = str(uuid4())
        cp = {
            "content_types": ["python_api", "configuration", "database", "mixed", "library", "testing", "web_app"][i % 7],
            "detected_patterns": ["fastapi", "react", "config", "schema", "project", "package", "pytest"][i % 7],
            "language": "python" if i % 3 == 0 else "javascript" if i % 3 == 1 else None,
        ...
        examples.append({
            ...
            "intelligence_metrics": {"confidence_score": 0.85 + (i % 15) / 100, "success_rate": 0.9 + (i % 10) / 100, "intelligence_score": 0.88},
